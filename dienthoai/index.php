	...
	<div id="footer">
		...
		<div id="bg-footer">
			<div id="noidungfooter">
				...
				<div id="noidung">
					<ul>
						<li><span id="tencongty">Công Ty TNHH ĐIỆN THOẠI Tiên Phong</span></li> <br>
						
						<li>Địa chỉ: Gò Vấp - HCM </li>
						<li>Điện thoại: 0976384659 - Hotline:  0976384659</li>
				...
				<div id="copyright">
					<p>Sinh Viên : Nguyễn Thanh Phước | Lớp : DHTH15A | Gmail : phuocnguyen230401@gmail.com<p>
				</div><!-- End .copyright -->
