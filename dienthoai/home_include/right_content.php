...
?> <?php  echo number_format($tongtien,"0",",",".");?> VNĐ
				...
				<div id="fb-root">
					<div class="center1">
						...
						<div class="fb-like-box" data-href="https://www.facebook.com/vyyanny" data-width="188" data-colorscheme="light" data-show-faces="true" data-header="true" data-stream="false" data-show-border="false"></div>
					</div><!-- End .center1 -->
				</div><!-- End .facebook -->